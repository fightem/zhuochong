...
def get_content(href):
    ...
    print(html)
    contents = html.xpath('*//div[@class="content_area"]/p')
...
def get_news_list(url):
    ...
    trs = html.xpath('//div[@class="text_con"]/h3[1]')
    hrefs = html.xpath('//div[@class="text_con"]/h3/a/@href')
    print(trs)
...
if __name__ == "__main__":
    # Example usage:
    url = "https://news.cctv.com/world/"  # 观察者网
